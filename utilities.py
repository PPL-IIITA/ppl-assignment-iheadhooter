...
def generateRandomItems():
	...
	for k in range(1000):
		temp = ['Boy' + str(k), randrange(100), randrange(100), randrange(300), randrange(100)]
		x = randrange(100) % 3
		if x == 0:
			trait = 'miser'
		elif x == 1:
	...
	writer = csv.writer(target, delimiter = ',')
	for k in range(500):
		temp = ['Girl' + str(k), randrange(100), randrange(300), randrange(100)]
		x = randrange(100) % 3
		if x == 0:
   	...
   	for k in range(1000):
   		...
   		if x == 0:
   			...
   			type = 'utility'
   		temp.append(type)
   		temp.append(randrange(45))
   		temp.append(randrange(3000))
