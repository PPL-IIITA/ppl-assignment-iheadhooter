...
if __name__ == '__main__':
	...
	kGirlsList = kBest(girlsList, k)
	kBoysList = kBest(boysList, k)
	kGiftsList = kBest(giftsList, k)
	for girl in kGirlsList:
		"""this loop assigns bf's to girls"""						
		for boy in kBoysList:
	...
	for couple in couplesList:				# the loop sets giftBasket for each couple and set happiness and compability of each 
		...
		girl = couple.girl
		giftBasket = boy.setGiftBasket(kGiftsList, girl)
